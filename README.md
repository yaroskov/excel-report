...
1. **Подготовка**:
   ...
   2. Создайте файл с логами пригодный для парсинга, для этого:
      1. Получите у **ответственного лица** исходный файл с логами в формате **Excell**.
      2. Откройте исходный **Excell файл** с логами и сохраните только 1 лист, в котором содержатся логи, в формат **htm/html**.
